...
TRAINING_CONFIG = {    
    # ====== Set up ======
    "writer_save_path": "runs/baseline_fullrestormer_ONN",  # runs/{run_file_name}
    "checkpoints_weights_save_dir": "./checkpoints_weights/baseline_fullrestormer_ONN",  # ./checkpoints_weights/{run_file_name}


    # ====== Resume training ======
    "resume_training": False,  # 開關，是否從 checkpoint 繼續訓練
    "resume_checkpoint_path": "./checkpoints_weights/baseline_fullrestormer_ONN/checkpoints/epoch30_valLoss0.0123_20251026_154501.pth",  # ./checkpoints_weights/{run_file_name}/checkpoints/...
...
TESTING_CONFIG = {    
    # load config
    "weight_save_dir": './checkpoints_weights/baseline_fullrestormer_ONN/weights',  # e.g.: ./checkpoints_weights/{run_name}/weights
    ...
    # save config
    "results_save_dir": './results/baseline_fullrestormer_ONN',
