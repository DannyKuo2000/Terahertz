...
ENCODER_CONFIG = {
    ...
    "blur_kernel_size": 10,
    "blur_sigma": 5,
    "gray_mean": 0,#0.6,     # background gray mean
    "gray_sigma": 0,#0.02,   # background gray std
    "gray_ratio": 0,#0.55,   # background mixed ratio
    "noise_std": 0,#10/255,  # Gaussian noise std
