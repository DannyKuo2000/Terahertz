...
ENCODER_CONFIG = {
    ...
    "resize_size_source": (2048, 2048),  # resize size, e.g., (H, W)
    "new_size_source": (2048, 2048),  # final size, e.g., (H, W)

    #====== ResizePadLayer ======
    "resize_size": (384, 288),  # resize size of input, e.g., (H, W)
    # "pad_size": (512, 512),  # final size of input, e.g., (H, W)
    # "resize_size": (256, 256),  # resize size, e.g., (H, W)
    "pad_size": (2048, 2048),  # final size, e.g., (H, W)
    #0.01344,
    #0.01008,
    #pitch: 35um
    ...
    # "dx": 0.000234375,
    "dx": 0.000035,
    "num_size_diffractive": 2048,          # 每層大小
